...
public class Customer implements User {
    ...
    public Customer(UserAdditionalInfo userAdditionalInfo, String familyName, String givenName, String id, Boolean isCustomer, Boolean isHealthcareWorker, Boolean isReceptionist, String phoneNumber,String userName, String sub) {
    ...
    public Customer(UserAdditionalInfo userAdditionalInfo, String familyName, String givenName, String id, Boolean isCustomer, Boolean isHealthcareWorker, Boolean isReceptionist, String phoneNumber,String userName) {
        this.userAdditionalInfo = userAdditionalInfo;
        this.familyName = familyName;
        this.givenName = givenName;
        this.id = id;
