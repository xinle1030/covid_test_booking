...
public class Patient implements User {
    ...
    public Patient(UserAdditionalInfo userAdditionalInfo, String familyName, String givenName, String id, Boolean isCustomer, Boolean isHealthcareWorker, Boolean isReceptionist, String phoneNumber,String userName, String sub) {
    ...
    public Patient(UserAdditionalInfo userAdditionalInfo, String familyName, String givenName, String id, Boolean isCustomer, Boolean isHealthcareWorker, Boolean isReceptionist, String phoneNumber,String userName) {
        this.userAdditionalInfo = userAdditionalInfo;
        this.familyName = familyName;
        this.givenName = givenName;
        this.id = id;
